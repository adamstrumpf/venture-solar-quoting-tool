...
- Dark theme throughout, amber accents for primary actions, teal for positive values, clear section separation
...
- Test Docker builds locally before deploying: `docker build -t venture-solar-quoting-tool . && docker run -p 8080:8080 venture-solar-quoting-tool`
...
claude --add-dir .
# Paste: "You are the Frontend Agent for venture-solar-quoting-tool. [Track B brief here]"

# Terminal 2 — start data-integration agent
claude --add-dir .
# Paste: "You are the Data Integration Agent for venture-solar-quoting-tool. [Track A brief here]"
```
